...
<section className="py-20 2xl:py-40 bg-black border-t-2 border-gray-300">
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap -mx-4 pb-24 mb-16 border-b border-gray-400">
            <div className="w-full lg:w-2/5 px-4 mb-16 lg:mb-0"><span className="text-lg text-yellow-400 font-bold">We're Not Too Busy</span>
              <h2 className="max-w-sm mt-8 mb-12 text-5xl text-white font-bold font-heading">Thank you for your time</h2>
              <p className="mb-16 text-gray-300">We're Not Too Busy </p>
              <div><a className="inline-block mb-4 sm:mb-0 sm:mr-4 py-4 px-12 text-black font-bold bg-yellow-500 hover:bg-yellow-600 rounded-full transition duration-200" href="#">Donate now</a><a className="inline-block px-12 py-4 text-yellow-500 font-bold border border-yellow-500 hover:border-yellow-600 rounded-full" href="#">Join & Support</a></div>
            </div>
              ...
              <div className="flex flex-wrap -mx-4">
                <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-16 lg:mb-0">
                  <ul className="text-lg">
                    ...
                    <li className="mb-6"><a className="text-gray-200 hover:text-gray-100" href="#">Applictaions</a></li>
          ...
          <div className="md:flex justify-between">
            <p className="text-lg text-gray-200 mb-8 md:mb-0">© 2022 Not2Busy. All rights reserved.</p>
            <div className="flex items-center"><a className="inline-block mr-2" href="#"><img className="h-12" src="zospace-assets/logos/facebook.svg" alt=""/></a>              <a class="inline-block mr-2" href="#"><img class="h-12" src="zospace-assets/logos/instagram.svg" alt=""/></a>              <a class="inline-block" href="#"><img class="h-12" src="zospace-assets/logos/twitter.svg" alt=""/></a></div>
          </div>
        </div>
      </section>
