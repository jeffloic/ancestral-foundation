...
const Contact = () => {
  return (
    <div className="relative pt-20 2xl:pt-40 bg-black">
        <div className="hidden lg:block absolute top-0 right-0 h-full bg-gray-900 w-1/2"></div>
        <div className="container px-4 mx-auto">
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-wrap -mx-4">
              <div className="relative w-full lg:w-1/2 px-4 pb-20 overflow-hidden">
                {/* <img className="hidden lg:block absolute bottom-0 right-0 w-full h-screen -mr-20 -mb-52" src="zospace-assets/lines/circle.svg" alt=""/>
                <img className="hidden lg:block absolute bottom-0 right-0 -mr-52 -mb-64" src="zospace-assets/lines/circle.svg" alt=""/> */}
                <div className="relative max-w-md">
                  <div className="pb-16 mb-8 border-b border-gray-400"><span className="text-lg text-yellow-400 font-bold">Have a question?</span>
                    <h2 className="mt-10 mb-16 text-5xl font-bold font-heading text-white">Contact with us</h2>
                    <div className="py-6 px-8 mb-4 bg-gray-900 rounded-lg">
                      <div className="flex items-center">
                        <span className="flex items-center justify-center w-12 h-12 mr-8 bg-yellow-500 rounded-lg">
                        ...
                        <p className="text-lg font-bold text-white">+233 20457523 00 01</p>
                      </div>
                    </div>
                    <div className="py-6 px-8 mb-4 bg-gray-900 rounded-lg">
                      <div className="flex items-center"><span className="flex items-center justify-center w-12 h-12 mr-8 bg-yellow-500 rounded-lg">
                        ...
                        <p className="text-lg font-bold text-white">center@not2busy.org</p>
                      </div>
                    </div>
                    <div className="py-6 px-8 mb-4 bg-gray-900 rounded-lg">
                      <div className="flex items-center"><span className="flex items-center justify-center w-12 h-12 mr-8 bg-yellow-500 rounded-lg">
                        ...
                        <p className="text-lg font-bold text-white">Bayswater, Miami</p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="relative w-full lg:w-1/2 px-4 pb-20">
                <div className="max-w-md lg:ml-20">
                  <form action="#">
                    ...
                    <input className="mb-3 w-full px-12 py-4 bg-white font-bold placeholder-gray-900 rounded-full focus:outline-none" type="email" placeholder="example@not2busy.org"/>
                    ...
                    <button className="py-4 px-12 text-black font-bold bg-white rounded-full transition duration-200">Send message</button>
                  </form>
                </div>
              </div>
            </div>
