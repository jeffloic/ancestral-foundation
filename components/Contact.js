...
<section className="relative pt-20 2xl:pt-40 bg-black">
        <div className="hidden lg:block absolute top-0 right-0 h-full bg-gray-900 w-1/2"></div>
        <div className="container px-4 mx-auto">
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-wrap -mx-4">
              <div className="relative w-full lg:w-1/2 px-4 pb-20 overflow-hidden"><img className="hidden lg:block absolute bottom-0 right-0 w-full h-screen -mr-20 -mb-52" src="zospace-assets/lines/circle.svg" alt=""/><img className="hidden lg:block absolute bottom-0 right-0 -mr-52 -mb-64" src="zospace-assets/lines/circle.svg" alt=""/>
