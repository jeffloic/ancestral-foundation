  ...
  return (
    <div className='py-10 bg-black'>
        <div className="relative h-[500px] sm:h-[400px] lg:h-[500px] xl:h-[600px] 2xl:h-[700px]">
            <Image 
              src="https://i.imgur.com/hpCcGPA.jpg"
              layout="fill"
              objectFit="cover"
            />
            <div className="absolute top-1/4 w-full text-center justify-center">
              <h2 className="max-w-4xl mx-auto uppercase text-center mb-14 text-5xl lg:text-6xl font-bold font-heading text-yellow-500">Our Ancestral Heritage</h2>
